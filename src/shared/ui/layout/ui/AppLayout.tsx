...
function AppLayout() {
  ...
  return (
    <div className="grid min-h-dvh grid-cols-[200px_1fr] grid-rows-[40px_1fr_auto] md:grid md:grid-cols-[240px_1fr] md:grid-rows-[56px_1fr_auto]">
      <header className="bg-secondary/0 sticky top-0 z-10 col-start-2 flex items-center justify-between px-5 py-2 text-2xl font-semibold tracking-wide backdrop-blur-sm">
        <h1 className="flex flex-wrap text-lg md:text-2xl">Task Manager</h1>
        <Button size={'sm'} variant={'secondary'} onClick={handleThemeToggle}>
      ...
      <aside className="border-border sticky top-0 col-start-1 row-span-3 row-start-1 min-h-dvh self-start border-r-2">
        <Logo />
